...
exports.JitoLeaderScheduler = void 0;
const web3_js_1 = require("@solana/web3.js");
const core_1 = require("@solana-arb-bot/core");
const logger = (0, core_1.createLogger)('JitoLeaderScheduler');
/**
 * Jito Leader 调度器
 */
class JitoLeaderScheduler {
    connection;
    jitoClient;
    leaderCache = new Map();
    maxAcceptableWaitSlots;
    enableCache;
    cacheDurationSlots;
    // 统计数据
    stats = {
    ...
    constructor(connection, jitoClient, config = {}) {
    ...
    async getLeaderSchedule() {
        try {
            ...
            for (const [validatorKey, slots] of Object.entries(schedule)) {
                const pubkey = new web3_js_1.PublicKey(validatorKey);
...
exports.JitoLeaderScheduler = JitoLeaderScheduler;
//# sourceMappingURL=jito-leader-scheduler.js.map